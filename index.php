...
<body>
  ...
  include 'navbar.php';
  ?>
  <img src="bank1.png" alt="" height="600px" width="100%">
  <div class="container-fluid">
    <!-- Introduction section -->
    <div class="row intro py-1" style="background-color: #50C878">
  ...
  <footer id="footer" class="text-center mt-5 py-2">
    <p>&copy 2021. Made by <b>KEERTHIGA DHANSEKARAN</b> <br> The Bank Foundation</p>
  </footer>
